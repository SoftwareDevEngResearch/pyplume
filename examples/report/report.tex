...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{examples/report/figs/general.pdf}
    \caption{General}
    \label{fig:general}
\end{figure}
...
These ideas led to the development of three models within \pyplume: \texttt{simple}, \texttt{linear}, and \texttt{grid}. The simple model is essentially Figure~\ref{fig:general} with added entrainment t
